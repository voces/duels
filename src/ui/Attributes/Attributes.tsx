...
export const Attributes = ({
	...
	>
		...
		/>
		<Row name="Class" value={heroTypeMap[hero.unit.typeId].name} first />
		<Row name="Level" value={hero.level.toString()} />
		<Row name="Experience" value={hero.expierence.toString()} />
		<Row
		...
		<Row
			name="Health"
			value={`${hero.health.toString()}/${hero.maxHealth.toString()}`}
		/>
